...
public class CalendarUtil {
    ...
    public static String solarToLunar(String solarDate) throws Exception {
        ...
        if (lunarMonth < 10 && lunarDay <10){
            sb.append(lunarYear).append("0").append(lunarMonth).append("0").append(lunarDay);
        }else if (lunarMonth < 10 && lunarDay >= 10){
            sb.append(lunarYear).append("0").append(lunarMonth).append(lunarDay);
        }else if (lunarMonth >= 10 && lunarDay < 10){
            sb.append(lunarYear).append(lunarMonth).append("0").append(lunarDay);
        }else if (lunarMonth >= 10 && lunarDay >= 10){
            sb.append(lunarYear).append(lunarMonth).append(lunarDay);
        }
        return sb.toString();
    }

    public static void main(String[] args){
        String date = "20090505";
        try {
            //农历转公历：转的是大的月份
            String newDate = CalendarUtil.lunarToSolar(date, true);
            //公历转农历
